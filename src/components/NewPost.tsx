  ...
  return (<div className="new-posts bg-white w-full px-4 py-2 rounded-md border-[1.5px] border-gray-300">
    <div className="flex flex-col">
      ...
      <div className="new-posts-options w-full flex items-center mt-3 justify-around">
        <div className="ask basis-[33%] cursor-pointer justify-center hover:bg-gray-100 hover:rounded-lg flex items-center gap-1 border-r-[1.2px] mr-1 border-gray-300 px-4">
        ...
        <div className="answers basis-[33%] cursor-pointer justify-center flex items-center gap-1 hover:bg-gray-100  hover:rounded-lg  border-r-[1.2px] border-gray-300 px-4">
