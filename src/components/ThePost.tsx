  ...
  return (<div className="the-post bg-white w-full max-h-fit mt-2 rounded-md border-[1.5px] overflow-hidden border-gray-300">
    <div className="post-header flex justify-between">
      <div className="post-profiles flex items-center gap-2 px-4 pt-3 pb-2">
        <div className="post-profile-picture overflow-hidden h-10 w-10 object-cover rounded-full border-[1.5px] border-gray-300 pointer-events-none select-none">
          <img src={authorPPUrl} alt="profile picture" className='w-full h-full object-cover' loading='lazy'/>
        </div>
        <div className="post-profile-data text-[13px]">
          <div className="post-profile-name font-bold ">
            <h3>{author}</h3>
          </div>
          <div className="post-profile-credentials text-gray-600 truncate lg:w-full w-10/12">
            {
               authorCredentials ? authorCredentials :  <span className='flex gap-2 truncate'>Software Engineering Student , SMKN 10 Jakarta (Lulus 2024)<span className='mr-[.8px] truncate'>·</span><p className="truncate">{postDate ? postDate : "2 Agustus"}</p></span>
            }
    ...
    <div className="post-contents">
      ...
      <div className="post-thumbnail w-full max-h-fit object-cover overflow-hidden select-none pointer-events-none">
        <img className='object-cover w-full h-full' src={thumbnailUrl} alt="thumbnail" loading='lazy'/>
      </div>
    </div>
          ...
          <div className="upvote  hover:bg-gray-200 flex border-[1.5px] border-gray-300 bg-gray-100 basis-[80%] items-center rounded-l-2xl">
            <div className="upvote-wrapper flex items-center py-1 pl-2 gap-1 cursor-pointer">
              ...
              <span className="flex items-center gap-1 text-gray-600  font-semibold">
                Dukung Naik  <p className="font-normal">{upvoteValue}</p>
              </span>
            </div>
          </div>
